...
export function MarketingPage({ onSignIn, notebookType = 'class', onNotebookTypeChange, featureFlags = {}, onFeatureFlagChange, onFluentComparison, selectedHero = 'hero1', onSelectedHeroChange, selectedBlade = 'none', onSelectedBladeChange, useAnimatedAssets = false, onAnimatedAssetsChange, useAnimatedAssetsAlt = false, onAnimatedAssetsAltChange, enableBlade0 = false, onEnableBlade0Change }: MarketingPageProps) {
  ...
  const renderStaffContent = () => (
    <>
        ...
        <div className="relative z-10 w-full px-6 py-20 md:py-32">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <h1 className="font-['Segoe_UI',sans-serif] font-semibold text-[32px] md:text-[40px] leading-[1.15] mb-4 md:mb-6 text-[#323130]">
                  OneNote Staff Notebook
                </h1>
                <p className="font-['Segoe_UI',sans-serif] font-light text-[16px] md:text-[20px] leading-[1.5] mb-8 text-[#323130]">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20" ref={oneNoteSection}>
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <h3 className="font-['Segoe_UI',sans-serif] text-[24px] text-[#323130] mb-6 leading-tight" style={{ fontWeight: 400 }}>
              Cultivate &amp; manage<br />educator collaboration
            </h3>
            <p className="font-['Segoe_UI',sans-serif] text-[15px] text-[#505050] mb-8 leading-relaxed">
      ...
      {/* Collaborate in one place */}
      <section
        className={`mobile-blade-fade py-20 ${selectedBlade === 'everyOther' ? 'bg-cover bg-center bg-no-repeat' : 'bg-[#f2f2f2]'}`}
        ref={organizeSection}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <div className="mt-8">
                <p className="font-['Segoe_UI',sans-serif] text-[15px] text-[#505050] mb-2">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <p className="font-['Segoe_UI',sans-serif] text-[15px] text-[#505050] mb-4 leading-relaxed">
                If you're using OneNote 2016, 2019, or 2021 and do not have Microsoft 365, you may still need to use the downloadable Staff Notebook add-in.
              </p>
              <div>
                <a href="#" className="font-['Segoe_UI',sans-serif] text-[15px] hover:underline inline-block" style={{ color: CLASS_ACCENT }}>
  ...
  const renderStickyTabs = () => (
    <nav className="sticky top-0 bg-white border-b border-[#d1d1d1] z-40">
      <div className="max-w-7xl mx-auto px-6">
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`relative py-4 font-['Segoe_UI',sans-serif] text-[15px] whitespace-nowrap transition-colors ${
                activeTab === tab
                  ? 'text-[#262626]'
                  : 'text-[#262626] hover:text-[#0078d4]'
              }`}
            >
              {tab}
              {activeTab === tab && (
                <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-[#000000] transition-all duration-300 ease-in-out" />
              )}
            </button>
          ))}
        </div>
        ...
        <div className="md:hidden relative">
          <button
            ...
            className="w-full flex items-center justify-between py-3 font-['Segoe_UI',sans-serif] text-[15px] text-[#262626]"
          >
          ...
          {isStickyTabsDropdownOpen && (
            <>
              ...
              <div className="absolute left-0 right-0 top-full bg-white shadow-lg border border-gray-200 rounded-b-md z-40">
                {tabs.map((tab) => (
                  <button
                    key={tab}
                    onClick={() => {
        ...
        <div className="max-w-[1600px] mx-auto px-6 py-12">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-4">
              <span className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050]">Follow Microsoft 365</span>
              <div className="flex gap-3">
                <a href="#" className="text-[#000000] hover:opacity-70" aria-label="LinkedIn">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
                <a href="#" className="text-[#000000] hover:opacity-70" aria-label="X">
                ...
                <a href="#" className="text-[#000000] hover:opacity-70" aria-label="YouTube">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
                <a href="#" className="text-[#000000] hover:opacity-70" aria-label="Instagram">
                ...
                <a href="#" className="text-[#000000] hover:opacity-70" aria-label="TikTok">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
            {/* What's new */}
            <div>
              <h3 className="font-['Segoe_UI:Semibold',sans-serif] text-[11px] text-[#505050] mb-3">What's new</h3>
              <ul className="space-y-2">
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Surface Pro</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Surface Laptop</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Surface Laptop Studio 2</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Copilot for organizations</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Copilot for personal use</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">AI in Windows</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Explore Microsoft products</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Windows 11 apps</a></li>
              </ul>
            </div>

            {/* Microsoft Store */}
            <div>
              <h3 className="font-['Segoe_UI:Semibold',sans-serif] text-[11px] text-[#505050] mb-3">Microsoft Store</h3>
              <ul className="space-y-2">
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Account profile</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Download Center</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft Store support</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Returns</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Order tracking</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Certified Refurbished</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft Store Promise</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Flexible Payments</a></li>
              </ul>
            </div>

            {/* Education */}
            <div>
              <h3 className="font-['Segoe_UI:Semibold',sans-serif] text-[11px] text-[#505050] mb-3">Education</h3>
              <ul className="space-y-2">
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft in education</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Devices for education</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft Teams for Education</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft 365 Education</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">How to buy for your school</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Educator training and development</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Deals for students and parents</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">AI for education</a></li>
              </ul>
            </div>

            {/* Business */}
            <div>
              <h3 className="font-['Segoe_UI:Semibold',sans-serif] text-[11px] text-[#505050] mb-3">Business</h3>
              <ul className="space-y-2">
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft AI</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft Security</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Dynamics 365</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft 365</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft Power Platform</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft Teams</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft 365 Copilot</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Small Business</a></li>
              </ul>
            </div>

            {/* Developer & IT */}
            <div>
              <h3 className="font-['Segoe_UI:Semibold',sans-serif] text-[11px] text-[#505050] mb-3">Developer & IT</h3>
              <ul className="space-y-2">
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Azure</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft Developer</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft Learn</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Support for AI marketplace apps</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft Tech Community</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Microsoft Marketplace</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Marketplace Rewards</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Visual Studio</a></li>
              </ul>
            </div>

            {/* Company */}
            <div>
              <h3 className="font-['Segoe_UI:Semibold',sans-serif] text-[11px] text-[#505050] mb-3">Company</h3>
              <ul className="space-y-2">
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Careers</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">About Microsoft</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Company news</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Privacy at Microsoft</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Investors</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Diversity and inclusion</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Accessibility</a></li>
                <li><a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Sustainability</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-gray-300">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex flex-wrap items-center gap-4">
                <button className="flex items-center gap-2 font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">
                ...
                <button className="flex items-center gap-1 font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">
                ...
                <a href="#" className="font-['Segoe_UI',sans-serif] text-[11px] text-[#505050] hover:underline">Consumer Health Privacy</a>
              </div>
              <div className="flex flex-wrap items-center gap-4 text-[11px]">
                <a href="#" className="font-['Segoe_UI',sans-serif] text-[#505050] hover:underline">Sitemap</a>
                <a href="#" className="font-['Segoe_UI',sans-serif] text-[#505050] hover:underline">Contact Microsoft</a>
                <a href="#" className="font-['Segoe_UI',sans-serif] text-[#505050] hover:underline">Privacy</a>
                <a href="#" className="font-['Segoe_UI',sans-serif] text-[#505050] hover:underline">Terms of use</a>
                <a href="#" className="font-['Segoe_UI',sans-serif] text-[#505050] hover:underline">Trademarks</a>
                <a href="#" className="font-['Segoe_UI',sans-serif] text-[#505050] hover:underline">Safety & eco</a>
                <a href="#" className="font-['Segoe_UI',sans-serif] text-[#505050] hover:underline">Recycling</a>
                <a href="#" className="font-['Segoe_UI',sans-serif] text-[#505050] hover:underline">About our ads</a>
                <span className="font-['Segoe_UI',sans-serif] text-[#505050]">© Microsoft 2026</span>
              </div>
            </div>
          </div>
        </div>
